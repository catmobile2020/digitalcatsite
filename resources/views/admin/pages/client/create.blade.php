                        ...
                        <form role="form" action="{{route('admin.clients.store')}}" method="post">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="code" name="code" placeholder="Master Code" value="{{old('code')}}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="city" name="city" placeholder="City Name" value="{{old('city')}}">
                                </div>
                                <div class="form-group">
                                    <label for="phone">Mobile Number</label>
                                    <input type="text" class="form-control" id="phone" name="phone" placeholder="Mobile Number" value="{{old('phone')}}">
                                </div>
                                <div class="form-group">
